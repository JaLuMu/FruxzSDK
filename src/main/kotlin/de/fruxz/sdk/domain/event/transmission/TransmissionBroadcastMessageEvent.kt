...
class TransmissionBroadcastMessageEvent(override val plugin: FruxzPlugin, override var transmission: Transmission, private var isCancelled: Boolean): Event(false), TransmissionBroadcastEvent {
